...
function StudentDashboard() {
  ...
  const handleUpdateElectives = async () => {
    try {
      ...
      await axios.delete("http://localhost:5000/api/student/openelective", {
        headers: { Authorization: `Bearer ${token}` },
      });
      navigate("/openelective");
     
    } catch (err) {
      setError("Failed to update chosen electives.");
    }
  };
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              {student.subjects && student.subjects.length > 0 ? (
                ...
                <div className="text-center">
                  ...
                  <Link
                    to="/openelective"
                    className="mt-4 inline-block px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition"
                  >
